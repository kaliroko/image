...
(function () {
    ...
    function detectLayout() {
        ...
        gate.classList.remove("is-landscape", "is-portrait", "is-tv", "is-desktop", "is-tablet", "is-mobile");
        ...
        if (w >= 1920 || (w >= 1600 && shortSide >= 900)) {
            isTV = true;
        } else if (w >= 1024) {
            isDesktop = true;
        } else if (w >= 641) {
        ...
        if (!isTV && w >= 1600 && dpr >= 1.5 && shortSide >= 800) {
            isTV = true;
            isDesktop = false;
        }

        if (isTV)      gate.classList.add("is-tv");
        else if (isDesktop) gate.classList.add("is-desktop");
        else if (isTablet)  gate.classList.add("is-tablet");
        else                gate.classList.add("is-mobile");

        var scale = 1;
        if (isTV) scale = Math.min(1.4, Math.max(1.1, w / 1920));
